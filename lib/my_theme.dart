...
class MyTheme {
  ...
  static const Color accent_color = Color(0xff86C440);
  ...
  static Color splash_screen_color = Color.fromRGBO(
      134, 196, 64, 1.0); // if not sure , use the same color as accent color
  ...
  //---------------
  static const Color brick_red = Color.fromRGBO(134, 196, 64, 1.0);
  static const Color cinnabar = Color.fromRGBO(134, 196, 64, 1.0);
