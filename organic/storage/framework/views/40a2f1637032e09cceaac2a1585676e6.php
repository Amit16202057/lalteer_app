    ...
    <!-- Top Bar -->
    <div style="background-color: #EDF6E2" class="top-navbar  z-1035 h-35px h-sm-auto">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col">
                    <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0 py-2">
                        <!-- Language switcher -->
                        <?php if(get_setting('show_language_switcher') == 'on'): ?>
                            <li class="list-inline-item dropdown mr-4" id="lang-change">
                                <a href="javascript:void(0)" class="dropdown-toggle fs-12 py-2"
                                    data-toggle="dropdown" data-display="static" style="color: black !important;">
                                ...
                                <ul class="dropdown-menu dropdown-menu-left">
                                    <?php $__currentLoopData = get_all_active_language(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(in_array($language->code, ['en', 'bd'])): ?>
                                            <li>
                                                <a href="javascript:void(0)" data-flag="<?php echo e($language->code); ?>"
                                                    ...
                                                    <img src="<?php echo e(static_asset('assets/img/placeholder.jpg')); ?>"
                                                        ...
                                                        class="mr-1 lazyload" alt="<?php echo e($language->name); ?>"
                                                        height="11">
                        ...
                        <?php if(get_setting('helpline_number')): ?>
                            ...
                            <li class="list-inline-item ml-3 pl-3 mr-0 pr-0">
                                <a href="tel:<?php echo e(get_setting('helpline_number')); ?>"
                                    class="fs-12 d-inline-block py-2" style="color: black !important;">
                ...
                <div class="col-lg-4 text-right d-none d-lg-block">
                    <ul class="list-inline  mb-0">
                      <li class="list-inline-item mr-0 pl-0 py-2">
                        <a target="__blank" style="color:black" href="https://lalteer.com"><?php echo e(translate('Corporate Website ')); ?></a>
                    </li>
                        <li class="list-inline-item mr-0 pl-2 py-2">
                            <a href="https://organic.lalteer.com/public/uploads/all/lalteerapk.apk">
                                <div class="download_app"><i class="fa-solid fa-mobile-screen-button"></i><?php echo e(translate('Download Mobile App')); ?></div>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="position-relative logo-bar-area border-md-nonea z-1025">
            <div class=" pl-2 pr-2">
                <div class="d-flex align-items-center">
                    ...
                    <?php
                        $nav_txt_color =
                            ...
                            get_setting('header_nav_menu_text') == null
                                ...
                                : 'text-white';
                    ?>
                    <div class="ml-xl-4 w-100 overflow-hidden d-none d-md-block">
                    ...
                    <div class="flex-grow-1 front-header-search d-flex align-items-center bg-white mx-xl-5 d-block d-md-none">
            ...
            <!-- Loged in user Menus -->
            <div style="left:99%;top:150%" class="hover-user-top-menu position-absolute right-0 z-3">
                <div class="container">
                                    ...
                                    <?php if(addon_is_activated('preorder')): ?>
                                        <li class="user-top-nav-element border border-top-0" data-id="1">
                                            <a href="<?php echo e(route('preorder.order_list')); ?>"
                                                ...
                                                <span
                                                    class="user-top-menu-name has-transition ml-3"><?php echo e(translate('Preorder List')); ?></span>
                                            </a>
                                        </li>
                                    <?php endif; ?>
        ...
        <div class="d-none d-lg-block position-relative  h-50px">
            <div class="pl-2 pr-2 h-100">
                <div class="d-flex h-100">
                    ...
                    <div class="d-none d-xl-block all-category has-transition  bg-primary" id="category-menu-bar">
                        <div class="px-3 h-100"
                            style="padding-top: 12px;padding-bottom: 12px; width:270px; cursor: pointer;">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <span class="fw-700 fs-16 text-white mr-3"><i
                                            class="fa-solid fa-bars pr-1"></i><?php echo e(translate('All Categories')); ?></span>
                    ...
                    <div class="flex-grow-1 front-header-search d-flex align-items-center bg-white mx-xl-5">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button type="submit" class="btn btn-success">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                ...
                                                <path
                                                    d="M9.847,17.839a7.993,7.993,0,1,1,7.993-7.993A8,8,0,0,1,9.847,17.839Zm0-14.387a6.394,6.394,0,1,0,6.394,6.394A6.4,6.4,0,0,0,9.847,3.453Z"
                                                    transform="translate(-1.854 -1.854)" fill="white" />
                                                <path
                                                    d="M24.4,25.2a.8.8,0,0,1-.565-.234l-6.15-6.15a.8.8,0,0,1,1.13-1.13l6.15,6.15A.8.8,0,0,1,24.4,25.2Z"
                                                    transform="translate(-5.2 -5.2)" fill="white" />
                                            </svg>
                                        </button>
                                    </div>
                     ...
                     <div>
                        <a href="<?php echo e(route('orders.track')); ?>" class="btn track_btn">
                            <i class="fa-solid fa-mobile-screen-button"></i> <?php echo e(translate('Track Orders')); ?>
                    ...
                    <div class="d-none d-xl-block ml-auto mr-0">
                        <?php if(auth()->guard()->check()): ?>
                            <span
                                class="d-flex align-items-center nav-user-info <?php if(isAdmin()): ?> ml-5 <?php endif; ?>"
                                id="nav-user-info">
                                <!-- Image -->
                                <span
                                ...
                                <!-- Name -->
                                <h4 class="h5 fs-14 fw-700 text-dark ml-2 mb-0"><?php echo e(translate($user->name)); ?></h4>
                            </span>
                        <?php else: ?>
                            <!--Login & Registration -->
                            <span class="d-flex align-items-center nav-user-info ml-3">
                                ...
                                <a href="<?php echo e(route('user.login')); ?>"
                                    class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block  border-soft-light border-width-2 pr-2 ml-3"><?php echo e(translate('Login')); ?></a>
...
<?php /**PATH /home/laltktyh/organic.lalteer.com/resources/views/frontend/inc/nav.blade.php ENDPATH**/ ?>