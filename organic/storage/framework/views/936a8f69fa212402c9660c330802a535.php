<?php $__env->startSection('content'); ?>
    <?php if($total_orders > 0): ?>
        <div class="bg-soft-primary p-3 rounded mb-3 d-flex justify-content-between align-items-center">
            <div>
                <h6 class="mb-1"><b>Summary</b></h6>
                <p class="mb-0">
                    Total Orders: <b><?php echo e($total_orders); ?></b> |
                    Total Amount: <b><?php echo e(single_price($total_amount)); ?></b>
                </p>
            </div>

            <div class="d-flex gap-2">
                
                <a href="<?php echo e(route('orders.export.filtered')); ?>?<?php echo e(http_build_query(request()->all())); ?>"
                    class="btn btn-success btn-sm">
                    Download Report (Excel)
                </a>

                
                <a class="btn btn-danger btn-sm text-white ml-2" onclick="window.print();">
                    Download PDF
                </a>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo e($order->orderDetails->sum('quantity')); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laltktyh/organic.lalteer.com/resources/views/backend/sales/index.blade.php ENDPATH**/ ?>