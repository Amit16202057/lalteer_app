<?php $__env->startSection('content'); ?>
    <!-- Cart Details -->
    <section class="my-4" id="cart-details" style="background-image: url('<?php echo e(static_asset('assets/img/Frame 1171277141.jpg')); ?>'); background-size: cover; background-position: center;">
    ...
    <script type="text/javascript">
        ...
        function updateQuantity(key, element) {
            $.post('<?php echo e(route('cart.updateQuantity')); ?>', {
                ...
                AIZ.extra.plusMinus();
                if (typeof window.initCartSummary === 'function') {
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laltktyh/organic.lalteer.com/resources/views/frontend/view_cart.blade.php ENDPATH**/ ?>