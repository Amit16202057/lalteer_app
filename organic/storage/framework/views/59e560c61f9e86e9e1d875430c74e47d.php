                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($user != null): ?>
                            <tr>
                                ...
                                <td>
                                    <p class="<?php if($user->banned == 1): ?> text-danger <?php elseif($user->is_suspicious == 1): ?> text-info <?php endif; ?>">
                                ...
                                <td class="text-right">
                                    <?php if($user->email_verified_at != null && auth()->user()->can('login_as_customer')): ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laltktyh/organic.lalteer.com/resources/views/backend/customer/customers/index.blade.php ENDPATH**/ ?>