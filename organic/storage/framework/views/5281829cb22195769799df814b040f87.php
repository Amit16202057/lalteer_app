            ...
            <form class="form-default" role="form" action="<?php echo e(route('addresses.store')); ?>" method="POST">
                ...
                <div class="modal-body c-scrollbar-light">
                    <div class="p-3">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <label><?php echo e(translate('Districts')); ?></label>
                            </div>
                            <div class="col-md-10">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <label><?php echo e(translate('Upazila')); ?></label>
                            </div>
                            <div class="col-md-10">
...
<?php /**PATH /home/laltktyh/organic.lalteer.com/resources/views/frontend/partials/address/address_modal.blade.php ENDPATH**/ ?>