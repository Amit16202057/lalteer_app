        ...
        <div class="container">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-4 bg-white rounded-0 border">
                    <!-- Category Name -->
                    <a href="<?php echo e(route('products.category', $category->slug)); ?>" class="text-dark p-4 d-flex align-items-center">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laltktyh/organic.lalteer.com/resources/views/frontend/all_category.blade.php ENDPATH**/ ?>