         ...
         <div class="">
             ...
             <div class="d-flex flex-wrap mb-2 mb-md-3 align-items-baseline justify-content-between">
                 ...
                 <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                     <span class="d-inline-block"><?php echo e(translate('Flash Deals')); ?></span>

                 </h3>
                 <div class="d-none d-md-block timer_flash">
                     <div class="bg-white">
                         <div class="aiz-count-down-circle" end-date="<?php echo e(date('Y/m/d H:i:s', $flash_deal->end_date)); ?>">
                         </div>
                     </div>
                 </div>
                 <!-- Links -->
 ...
 <?php endif; ?>
<?php /**PATH /home/laltktyh/organic.lalteer.com/resources/views/frontend/classic/partials/flash_deal.blade.php ENDPATH**/ ?>