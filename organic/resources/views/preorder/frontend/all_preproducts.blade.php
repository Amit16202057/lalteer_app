                ...
                <div class="row">
                                            ...
                                            @else
                                                <li class="mb-3">
                                                    <a class="text-reset fs-14 fw-600 hov-text-primary"
                                                        href="{{ route('all_preorder_products') }}">
                                        ...
                                        <div class="p-3 aiz-checkbox-list">
                                            <label class="aiz-checkbox mb-3">
                                                <input type="checkbox" name="is_available[]" value="1"
                                                    @if ($is_available == 1) checked @endif onchange="filter()">
                                                <span class="aiz-square-check"></span>
                                                <span
                                                    class="fs-14 fw-400 text-dark">{{ translate('Available Now') }}</span>
                                            </label>
                                            <label class="aiz-checkbox mb-3">
                                                <input type="checkbox" name="is_available[]" value="0"
                                                    @if ($is_available == 0) checked @endif onchange="filter()">
                                                <span class="aiz-square-check"></span>
                    ...
                    <div class="col-xl-9">
                        ...
                        <ul class="breadcrumb bg-transparent py-0 px-1">
                            ...
                            @else
                                <li class="breadcrumb-item opacity-50 hov-opacity-100">
                                    <a class="text-reset"
                                        href="{{ route('search') }}">{{ translate('All Preorder Products') }}</a>
                                </li>
                            @endif
                            @if (isset($category_id))
                        ...
                        <div class="card p-4">
                            <div class="px-3">
                                <div
                                    class="row gutters-16 row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2">
                                    @foreach ($preorder_products as $key => $product)
                                        <div class="col z-1 mt-2">
                                            @include('preorder.frontend.product_box2', [
                                                'product' => $product,
                                            ])
                                        </div>
                                    @endforeach
