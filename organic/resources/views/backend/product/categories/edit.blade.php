                    ...
                    <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <small
                                    class="text-muted">{{ translate('Minimum dimensions required: 292px width X 292px height.') }}</small>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="faq-section">
                            ...
                            <div class="col-md-9">
                                <div id="faq-container">
                                    <!-- Load existing FAQ items dynamically -->
                                    @if (!empty($category->faqs))
                                        @foreach ($category->faqs as $faq)
                                            <div class="faq-item row mb-2">
                                                <div class="col-md-5">
                                                    <input type="text" name="faq_questions[]"
                                                        value="{{ $faq->faq_questions }}"
                                                        placeholder="Enter FAQ Question" class="form-control" required>
                                                </div>
                                                <div class="col-md-5">
                                                    <input type="text" name="faq_answers[]"
                                                        value="{{ $faq->faq_answers }}" placeholder="Enter FAQ Answer"
                                                        class="form-control" required>
                                                </div>
                                                <div class="col-md-2">
                                                    <button type="button"
                                                        class="btn btn-danger remove-faq">Remove</button>
                                                </div>
                                            </div>
                                        @endforeach
                                    @endif
                                ...
                                <button type="button" id="add-faq"
                                    class="btn btn-primary mt-2">{{ translate('Add FAQ') }}</button>
                            </div>
                        </div>
...
@section('script')
    <script type="text/javascript">
        ...
        document.getElementById('add-faq').addEventListener('click', function() {
            ...
            faqItem.classList.add('faq-item', 'row', 'mb-2');
            faqItem.innerHTML = `
            <div class="col-md-5">
                <input type="text" name="faq_questions[]" placeholder="Enter FAQ Question" class="form-control" required>
            </div>
            <div class="col-md-5">
                <input type="text" name="faq_answers[]" placeholder="Enter FAQ Answer" class="form-control" required>
            </div>
            <div class="col-md-2">
                <button type="button" class="btn btn-danger remove-faq">Remove</button>
            </div>
        `;
            document.getElementById('faq-container').appendChild(faqItem);
        ...
        // Remove existing FAQ functionality
