                        ...
                        <div class="faq-section">
                            ...
                            <div class="col-md-9">
                                <div id="faq-container">
                                    <!-- Template for dynamic FAQ items -->
                                    <div class="faq-item row mb-2">
                                        <div class="col-md-5">
                                            <input type="text" name="faq_questions[]" placeholder="Enter FAQ Question"
                                                class="form-control" required>
                                        </div>
                                        <div class="col-md-5">
                                            <input type="text" name="faq_answers[]" placeholder="Enter FAQ Answer"
                                                class="form-control" required>
                                        </div>
                                        <div class="col-md-2">
