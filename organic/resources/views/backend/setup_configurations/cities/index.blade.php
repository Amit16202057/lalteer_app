...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
    	<div class="row align-items-center">
    		<div class="col-md-12">
    			<h1 class="h3">{{translate('All Thana')}}</h1>
    		</div>
    	</div>
    </div>
    <div class="row">
                ...
                <form class="" id="sort_cities" action="" method="GET">
                    <div class="card-header row gutters-5">
                        <div class="col text-center text-md-left">
                            <h5 class="mb-md-0 h6">{{ translate('Thana') }}</h5>
                        </div>
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="sort_city" name="sort_city" @isset($sort_city) value="{{ $sort_city }}" @endisset placeholder="{{ translate('Type thana name & Enter') }}">
                        </div>
                        <div class="col-md-4">
    			...
    			<div class="card-body">
    				<form action="{{ route('cities.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="country">{{translate('Districts')}}</label>
