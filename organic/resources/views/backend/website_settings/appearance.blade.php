            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <!-- Map link -->
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Map Link') }}</label>
                            <div class="col-md-8">
                                <input type="hidden" name="types[]" value="map_link">
                                <input type="text" name="map_link" class="form-control"
                                    placeholder="{{ translate('Contact Us Map link here') }}"
                                    value="{{ get_setting('map_link') }}">
                            </div>
                        </div>
                        <!-- Site Icon -->
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" name="secondary_base_color" class="form-control"
                                    placeholder="#ffc519" value="{{ get_setting('secondary_base_color') }}">
                                <small class="text-muted">{{ translate('Hex Color Code') }}</small>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" name="secondary_base_hov_color" class="form-control"
                                    placeholder="#dbaa17" value="{{ get_setting('secondary_base_hov_color') }}">
                                <small class="text-muted">{{ translate('Hex Color Code') }}</small>
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label
                                class="col-md-3 col-from-label">{{ translate('Use Image Watermark (During Upload)') }}</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row @if (get_setting('image_watermark_type') == 'text') d-none @endif" id="watermark_image">
                            ...
                            <div class="col-md-8">
                                <div class="input-group " data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input type="hidden" name="watermark_image"
                                        value="{{ get_setting('watermark_image') }}" class="selected-files">
                                </div>
                                <div class="file-preview box"></div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="watermark_text" class="form-control"
                                        placeholder="Watermark Text" value="{{ get_setting('watermark_text') }}">
                                </div>
                            </div>
                            <!-- Watermark Text Size -->
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="number" name="watermark_text_size" class="form-control"
                                        placeholder="Ex: 20" value="{{ get_setting('watermark_text_size') }}">
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control aiz-color-input"
                                            placeholder="Ex: #e1e1e1" name="watermark_text_color"
