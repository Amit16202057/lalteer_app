        ...
        <div class="container text-left">
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    ...
                    <div class="text-center py-4 mb-0 bg-white rounded-2">
                        ...
                        <h1 class="mb-2 fs-28 fw-500">{{ translate('Your Order is Successfully place') }}</h1>
                        <p class="fs-13 text-soft-dark">
                            {{ translate('Payment success rate refers to the percentage of attempted payments that are
                                                        successfully processed. ') }}
                            <strong>{{ json_decode($first_order->shipping_address)->email }}</strong>
                        </p>
                        <a href="{{ url('/') }}" class="btn btn-success text-center text-white">Continue</a>
                    </div>
                    <!-- Order Summary -->
