...
@section('meta_title'){{ $page->meta_title ?? 'Lalteer | Contact Us' }}@stop
    ...
    <section class="mb-1 pt-3">
        <div class="product-details-bredcrumb" style="position: relative; text-align: center;">
            ...
            <h2
                ...
                {{ translate($page->getTranslation('title')) }}</h2>
        </div>
    </section>

    <section class="pt-4 my-4" style="background-image: url('{{ static_asset('assets/img/p_details_bg.jpg') }}'); background-size: cover; background-position: center;">
        @php
                    ...
                    <div class="col-lg-4 text-center text-lg-left">
                        <div class="p-3 p-md-4 p-xl-5">
                            ...
                            <div class="d-flex pb-2 ">
                                ...
                                <span class="fs-19 fw-700">{{ translate('Customer Support') }}</span><br>
                            </div>
                            <div class="mb-4">
                                <span class="fs-14">{!! str_replace(['{{customer_support}}', "\n"], [translate('Customer Support'), '<br>'], $content->description) !!}</span>
                            </div>
                            <div class="d-flex pb-2">
                                <span class="d-flex align-items-center justify-content-center pr-2">
                                    ...
                                    <span class="fs-19 fw-700">{{ translate('Call Us') }}</span><br>
                            </div>
                            <div class="fs-14 mb-4">{{ translate($content->phone) }}</div>
                            <div class="d-flex pb-2">
                                <span class="d-flex align-items-center justify-content-center pr-2">
                                    <i class="las la-2x la-envelope"></i>
                                </span>
                                
                                    <span class="fs-19 fw-700">{{ translate('Email Support') }}</span><br>
                            </div>
                            <div class="fs-14 "><a href="mailto:{{ $content->email }}">{{ translate($content->email) }}</a></div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="pb-3 ">
                            ...
                            <div class=" p-4 p-xl-2rem">
                                <form class="form-default" role="form" action="{{ route('contact') }}" method="POST">
                                    ...
                                    <!-- Name -->
                                    <div class="form-group">
                                        <label for="name" class="fs-14 fw-700 text-soft-dark">{{ translate('Company Name') }}</label>
                                        <input type="text" class="form-control rounded-0" value="{{ old('company_name') }}" placeholder="{{ translate('Company Name') }}" name="company_name">
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                        <!-- Email -->
                                        <div class="form-group">
                                            <label for="email" class="fs-14 fw-700 text-soft-dark">{{ translate('Email Address') }}</label>
                                        ...
                                        <!-- Phone -->
                                        <div class="form-group">
                                            <label for="phone" class="fs-14 fw-700 text-soft-dark">{{ translate('Phone Number') }}</label>
                                    ...
                                    <!-- Query -->
                                    <div class="form-group">
                                        <label for="query" class="fs-14 fw-700 text-soft-dark">{{ translate('How can we help?') }}</label>
                                        <textarea
        ...
        <div class="col-md-12">
            ...
            <iframe src="{{ $map->value }}" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </section>
@endsection
