                                        ...
                                        <div class="bg-white border mb-3">
                                            <div class="fs-16 fw-700 p-3">
                                                <a href="#"
                                                    ...
                                                    style="white-space: normal;">
                                                    {{ $attribute->getTranslation('name') == 'weight' ? 'Product Type' : $attribute->getTranslation('name') }}
                                                </a>
                                            </div>
                                            @php
                                                $show = '';
                                        ...
                                        <div class="rating-filter">
                                            <label>
                                                <input type="checkbox" name="rating[]" value="5" id="rating5"
                                                    @if (in_array('5', request('rating', []))) checked @endif>
                                                <span class="stars">★★★★★</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="rating[]" value="4" id="rating4"
                                                    @if (in_array('4', request('rating', []))) checked @endif>
                                                <span class="stars">★★★★</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="rating[]" value="3" id="rating3"
                                                    @if (in_array('3', request('rating', []))) checked @endif>
                                                <span class="stars">★★★</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="rating[]" value="2" id="rating2"
                                                    @if (in_array('2', request('rating', []))) checked @endif>
                                                <span class="stars">★★</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="rating[]" value="1" id="rating1"
                                                    @if (in_array('1', request('rating', []))) checked @endif>
                                                <span class="stars">★</span>
                                            </label>
                                        </div>
                     ...
                     <div class="px-sm-3">
                            <div
                                ...
                                @foreach ($products as $key => $product)
                                    <div class="col-md-4 {{ $loop->last ? '' : 'mb-2' }}">
                                        @if (isset($product_type) && $product_type == 'preorder_product')
                                        ...
                                        @else
                                            <div
                                                class=" position-relative has-transition hov-animate-outline border @if ($key == 0) border-left @endif">
                                                @include(
