@extends('frontend.layouts.user_panel')
        @php
            ...
            $shipping = $order->orderDetails->sum('shipping_cost'); // or $order->shipping_cost if stored once
            $coupon   = $order->coupon_discount ?? 0;
            $tax      = $order->orderDetails->sum('tax');

            // final total = subtotal + shipping + tax - coupon
                    ...
                    <table class="table-borderless table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <span class="text-italic">{{ single_price(round($order->orderDetails->sum('shipping_cost'))) }}</span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <strong>{{ single_price(round($total)) }}</strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
