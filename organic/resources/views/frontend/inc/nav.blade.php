            ...
            <div class="row">
                            ...
                            <li class="list-inline-item dropdown mr-4" id="lang-change">
                                ...
                                <ul class="dropdown-menu dropdown-menu-left">
                                    @foreach (get_all_active_language() as $language)
                                        @if (in_array($language->code, ['en', 'bd']))
                                            <li>
                ...
                <div class="col-lg-4 text-right d-none d-lg-block">
                    <ul class="list-inline  mb-0">
                      <li class="list-inline-item mr-0 pl-0 py-2">
                        <a target="__blank" style="color:black" href="https://lalteer.com">{{ translate('Corporate Website ') }}</a>
                    </li>
                        <li class="list-inline-item mr-0 pl-2 py-2">
                            <a href="https://organic.lalteer.com/public/uploads/all/lalteerapk.apk">
                                <div class="download_app"><i class="fa-solid fa-mobile-screen-button"></i>{{ translate('Download Mobile App') }}</div>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="pl-2 pr-2 h-100">
                <div class="d-flex h-100">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <span class="fw-700 fs-16 text-white mr-3"><i
                                            class="fa-solid fa-bars pr-1"></i>{{ translate('All Categories') }}</span>
                    ...
                    <div class="flex-grow-1 front-header-search d-flex align-items-center bg-white mx-xl-5">
                     ...
                     <div>
                        <a href="{{ route('orders.track') }}" class="btn track_btn">
                            <i class="fa-solid fa-mobile-screen-button"></i> {{ translate('Track Orders') }}
                        </a>
                    </div>
                    ...
                    <div class="d-none d-xl-block ml-auto mr-0">
                        @auth
                            <span
                                ...
                                <!-- Name -->
                                <h4 class="h5 fs-14 fw-700 text-dark ml-2 mb-0">{{ translate($user->name) }}</h4>
                            </span>
                        @else
                            <!--Login & Registration -->
                    ...
                    <!-- Cart -->
                    {{-- <div class="d-none d-xl-block align-self-stretch ml-5 mr-0 has-transition bg-black"
                        data-hover="dropdown">
