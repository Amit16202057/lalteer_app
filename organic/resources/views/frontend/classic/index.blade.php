...
@section('content')
    ...
    <!-- Sliders -->
    @include('frontend.classic.slider')
    ...
    @include('frontend.classic.partials.flash_deal')
    <!-- Featured Products -->
    <div id="section_featured" style="background: url('{{ asset('public/assets/img/product_bg.jpg') }}') no-repeat center center/cover;">
                ...
                <div class="col-md-8 mb-4">
                    <div class="position-relative">
                        <div class="text-overlay top-50 start-50 text-white ads-banner-text-centent-sec">
                            <span>{{ $ads_banner_title1[$key] ?? '' }}</span>
                            <h1 class="py-4">{{ $ads_banner_title2[$key] ?? '' }}</h1>
                            <a href="{{ $home_slider_links[$key] ?? '#' }}" class="btn btn-light text-dark">
                                {{ $ads_banner_btn_text[$key] ?? 'Click Here' }}
                            </a>
                        </div>
                        <img class="ads-banner-text-centent-sec-img" src="{{ isset($slider['file_name']) ? my_asset($slider['file_name']) : static_asset('assets/img/placeholder.jpg') }}"
            ...
            <div class="p-2">
                ...
                <div class="row g-2">
                    @foreach ($banner_1_imags as $key => $value)
                        <div class="{{ $key == 0 ? 'col-lg-8' : 'col-lg-4' }} col-12">
    ...
    @endif
    @include('frontend.classic.partials.newsletter')
@endsection
