...
@if (get_setting('best_selling') == 1 && count($best_selling_products) > 0)
 <section class="mb-2 mb-md-3 mt-2 mt-md-3" style="background: url('{{ asset('public/assets/img/product_bg.jpg') }}') no-repeat center center/cover;">
        ...
        <div class="">
            ...
            <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                ...
                <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                    <span class="p-3">{{ translate('Top Product') }}</span>
                </h3>
                <!-- Links -->
                {{-- <div class="d-flex">
