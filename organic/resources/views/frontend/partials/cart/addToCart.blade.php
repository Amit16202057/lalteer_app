<div class="modal-body px-4 py-5 c-scrollbar-light">
    <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="category_nam text-dark opacity-80">
                        {{ translate(getCategoryName($product->category_id)) }}</div>
                    <div class="cat_des">
                        {!! \Illuminate\Support\Str::words($product->getTranslation('description', app()->getLocale()), 100) !!}
                    </div>
        ...
        <div class="col-lg-12 pt-3">
            <div class="text-left">
                <!-- Product name -->
                <strong>{{ translate('Choose a size') }}</strong>
                                            ...
                                            @foreach ($choice->values as $key => $value)
                                                <div class="my_cart mb-4">
                                                    <div class="product-name">
                                                        ...
                                                        <h5 class="text-dark">{{ $product->getTranslation('name') }} (
                                                            <span class="text-primary">{{ translate($value) }}</span>)
                                                        </h5>
                                                        <div class="">
