<div class="z-3 sticky-top-lg">
    <div class="card rounded-0 border">
        ...
        <!--@endforeach-->
        @php
            $default_shipping_cost = (int) \App\Models\BusinessSetting::where('type', 'flat_rate_shipping_cost')->value('value');
            $shipping_cost = session('shipping_cost', $default_shipping_cost);
            ...
            if (!session()->has('shipping_location')) {
                session(['shipping_location' => 'inside_dhaka']);
            }
        @endphp
        ...
        @foreach ($carts as $key => $cartItem)
            @php
                ...
                // Use session or default shipping
                $product_shipping_cost = $shipping_cost / count($carts);
                $shipping += $product_shipping_cost;
        ...
        <div class="card-header pt-4 pb-1 border-bottom-0">
            ...
            <h3 class="fs-18 fw-700 mb-0">{{ translate('Order Summary') }}</h3>
            <span class="text-right">
                <button class="btn btn-secondary" onclick="window.location='{{ route('search') }}'">
                    {{ translate('Add more') }} <i class="fa-solid fa-plus"></i>
                </button>
            </span>
        ...
        <div id="collapsePaymentInfo" class="collapse show" aria-labelledby="headingPaymentInfo"
            ...
            <div class="card-body" id="payment_info">
                ...
                <div class="row align-items-center pt-3 mb-4">
                    ...
                    {{-- 
                    <div class="col-6">
                        <a href="" class="btn btn-link fs-14 fw-700 px-5 text-danger border-danger"
