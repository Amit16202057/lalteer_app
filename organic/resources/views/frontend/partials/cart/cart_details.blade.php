        ...
        <div class="row">
            <div class="col-lg-8">
                            ...
                            <div class="aiz-checkbox-inline mb-3">
                                <label class="aiz-checkbox">
                                    <input type="checkbox" class="check-all"
                                        @if (count($active_carts) == $cart_count) checked @endif>
                                    <span class="fs-20 text-balck fw-700 ml-3">{{ translate('Shopping Cart Items') }}
                                        ({{ $cart_count }})</span>
                                    ...
                                    <div class="aiz-checkbox-inline">
                                        <label class="aiz-checkbox d-block">
                                            <input type="checkbox" class="check-one check-seller" value="admin"
                                                @if ($all_admin_products) checked @endif>
                                        ...
                                        <div class="row gutters-5 align-items-center">
                                            ...
                                            <div class="col-md-6 col-10 d-flex align-items-center mb-2 mb-md-0">
                                                ...
                                                <span>
                                                    ...
                                                    <span
                                                        class="fs-16 fw-700 text-success text-truncate-2 mb-2">{{ $product->getTranslation('name') }}</span>
                                                    ...
                                                    <span class="d-flex flex-row">
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            class="bg-danger rounded-1 text-white p-1"><i
                                                                ...
                                                                style="margin-right: 5px;"></i>{{ translate('Remove Item') }}</a>
                                                        <a class="bg-success rounded-1 text-white p-1"
                                                            style="margin-left: 10px;"><i
                                                                class="fa-regular fa-heart me-1"></i>{{ translate('Move to Favourite') }}</a>
                                                    </span>
                                                </span>
                                            ...
                                            <div class="col-md-2">
                                                @if ($admin_product_variation[$key] != '')
                                                    <span
                                                        class="text-success">{{ $admin_product_variation[$key] }}</span>
                                                @endif
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <span
                                                    class="fw-700 fs-14 text-primary">{{ single_price(cart_product_price($cartItem, $product, false) * $cartItem->quantity) }}</span>
                                            </div>
                                            <div class="col-md col-4 ml-4 ml-sm-0 my-3 my-md-0 d-flex flex-column ml-sm-5 ml-md-0"
                                                ...
                                                <span
                                                    class="fw-700 fs-14 mb-2">{{ cart_product_price($cartItem, $product, true, false) }}</span>
                                                <span>
                                                    <span class="opacity-90 fs-12">{{ translate('Tax') }}:
                                                        {{ cart_product_tax($cartItem, $product) }}</span>
                                                </span>
                                            </div>
                                            <!-- Quantity & Total -->
                                            <div
                                            ...
                                            {{-- <div class="col-auto text-right">
                                                <a href="javascript:void(0)"
                                                    onclick="removeFromCartView(event, {{ $cartItem->id }})"
                                                    class="btn btn-icon btn-sm bg-white hov-svg-danger"
                                                    title="{{ translate('Remove') }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="12.27"
                                                        height="16" viewBox="0 0 12.27 16">
                                                        <g id="Group_23970" data-name="Group 23970"
                                                            transform="translate(-1332 -420)">
                                                            <path id="Path_28714" data-name="Path 28714"
                                                                ...
                                                                transform="translate(1325.522 416.678)"
                                                                fill="#9d9da6" />
                                                        </g>
                                                    </svg>
                                                </a>
                                        ...
                                        <div class="aiz-checkbox-inline">
                                            <label class="aiz-checkbox d-block">
                                                <input type="checkbox" class="check-one check-seller"
                                                    value="seller-{{ $key }}"
                                                    @if ($all_seller_products) checked @endif>
                                                <span
                                            ...
                                            <div class="row gutters-5 align-items-center">
                                                ...
                                                <div class="col-auto">
                                                    <div class="aiz-checkbox pl-0">
                                                        <label class="aiz-checkbox">
                                                            <input type="checkbox"
                                                                class="check-one check-one-seller-{{ $key }}"
                                                                name="id[]" value="{{ $product_id }}"
                                                                @if ($cartItem->status == 1) checked @endif>
                                                            <span class="aiz-square-check"></span>
                                                        </label>
                                                ...
                                                <div class="col-md-5 col-10 d-flex align-items-center mb-2 mb-md-0">
                                                    ...
                                                    <span>
                                                        <span
                                                            class="fs-14 fw-400 text-dark text-truncate-2 mb-2">{{ $product->getTranslation('name') }}</span>
                ...
                <div class="d-flex flex-row justify-content-center align-items-center">
                    <a href="{{ url('/') }}" class="btn btn-success fs-16 fw-600 rounded-2 px-4 text-white"
                        style="margin-right: 10px;">{{ translate('Continue Shopping') }}</a>
                    <!--<a href="{{ route('checkout') }}" class="btn btn-danger fs-16 fw-600 rounded-2 px-4 text-white">{{ translate('Buy Now') }}</a>-->
                </div>
            </div>
