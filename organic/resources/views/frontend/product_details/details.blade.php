<div class="text-left">
    <span class="opacity-60">{{ translate(getCategoryName($detailedProduct->category_id)) }}</span>
    <!-- Product Name -->
                                        ...
                                        <label class="aiz-megabox pl-0 mr-2 mb-0">
                                            ...
                                            <span
                                                ...
                                                <sup class="fs-12 opacity-80">
                                                    @if ($variantBasePrice != $variantDiscountedPrice)
                                                        <del class="text-secondary">{{ $variantBasePrice }}</del>
                                                    @endif
