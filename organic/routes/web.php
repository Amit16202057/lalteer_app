...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/about-us-page', 'about_us')->name('about-us-page');
...
// Route::post('/delete-product', [OrderController::class, 'deleteProduct'])->name('delete-product');
...
//changing email verification 'verified'
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/update-quantity', [OrderController::class, 'updateQuantity'])->name('update-quantity');
    Route::post('/delete-product', [OrderController::class, 'deleteProduct'])->name('delete-product');
    Route::get('/products/search', [OrderController::class, 'productsSearch'])->name('products-search');
    // Route::post('/order-product-save', [OrderController::class, 'save_product'])->name('all_orders.add');
});
...
Route::get('/faqs/{id}', [FaqController::class, 'getCategoryFaqs']);
...
Route::get('/wishlist-product', [AboutUsController::class, 'WishlistProduct'])->name('wishlistproduct');
