...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::post('/orders/{id}/remarks', [\App\Http\Controllers\OrderController::class, 'updateRemarks'])->name('order.update_remarks');
        ...
        Route::get('/orders/export/filtered', [OrderController::class, 'export_filtered'])->name('orders.export.filtered');
