...
class HomeController extends Controller
{
    ...
    public function manifest()
    {
        ...
        $manifest = [
            ...
            "short_name" => get_setting('site_motto'),
    ...
    public function variant_price(Request $request)
    {
        ...
        $allowDefaultFallback = empty($str);
        $product_stock = find_product_stock_by_variant($product, $str, $allowDefaultFallback);
        ...
        $quantity = $product_stock ? $product_stock->qty : (int) ($product->current_stock ?? 0);
        $max_limit = $quantity;
    ...
    public function about_us(){
         $lang = get_system_language() ? get_system_language()->code : null;
        return view('frontend.about_us', compact('lang'));
    }
}
